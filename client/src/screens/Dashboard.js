                    ...
                    <div class="flex-1 px-2 sm:px-0">
                        ...
                        <div class="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div class="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
                                ...
                                <p class="text-white/50">Quanitity:</p>
                                <p class="absolute top-2 text-white/20 inline-flex items-center text-xs">View <span class="ml-2 w-2 h-2 block bg-green-500 rounded-full group-hover:animate-pulse"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
